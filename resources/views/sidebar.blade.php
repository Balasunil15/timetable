...
<div class="sidebar" id="sidebar">
    ...
    <div class="menu">
        @if (session('role') == 'hod')
            <a href="{{ route('hoddashboard') }}" class="menu-item {{ (!request()->routeIs('subjects') && !request()->routeIs('advisors')) ? 'active' : '' }}">
        ...
        @elseif (session('role') == 'faculty')
            <a href="{{ route('facultydashboard') }}" class="menu-item {{ request()->routeIs('facultydashboard') ? 'active' : '' }}">
                <i class="fas fa-tachometer-alt text-primary"></i>
                <span>Dashboard</span>
            </a>
            @if (session('advisor') == 1)
                <a href="{{ route('advisorsubjects') }}" class="menu-item {{ request()->routeIs('advisorsubjects') ? 'active' : '' }}">
                    <i class="fas fa-book text-success"></i>
                    <span>Subjects</span>
                </a>
                <a href="{{ route('studentslist') }}" class="menu-item {{ request()->routeIs('studentslist') ? 'active' : '' }}">
